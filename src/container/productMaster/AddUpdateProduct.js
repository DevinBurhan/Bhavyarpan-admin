...
const AddUpdateProduct = () => {
    ...
    return (
        <div className="pageHeading">
            ...
            <Form form={form} initialValues={{ remember: true }} autoComplete="off" onFinish={handleFinish} layout="vertical">
                <Row gutter={[20, 0]}>
                    <Col span={24} md={18}>
                    ...
                    <Col span={24} md={6}>
                        <Form.Item label="Select Subcategory" name="subCategory" rules={[{ required: true, message: "Please input the description!" }]}>
                            <Select
                                size={"large"}
                                showSearch
                    ...
                    <Col span={24} md={6}>
                        <Form.Item label="Before Price" name="beforePrice" rules={[{ required: true, message: "Please input before price!" }]}>
                            <Input type="number" placeholder="Enter Price" />
                        </Form.Item>
                    </Col>

                    <Col span={24} md={6}>
                        <Form.Item label="After Price" name="afterPrice" rules={[{ required: true, message: "Please input after price!" }]}>
                            <Input type="number" placeholder="Enter Price" />
                        </Form.Item>
                    </Col>

                    <Col span={24} md={6}>
                        <Form.Item label="InStock Quantity" name="inStockQuantity" rules={[{ required: true, message: "Please input InStock Quantity!" }]}>
                            <Input type="number" placeholder="Enter Quantity" />
                        </Form.Item>
                    </Col>

                    <Col span={24} md={6}>
                        <Form.Item label="OutStock Quantity" name="outStockQuantity" rules={[{ required: true, message: "Please input OutStock Quantity!" }]}>
                            <Input type="number" placeholder="Enter Quantity" />
                        </Form.Item>
                    </Col>
                    ...
                    {value ? (
                        <Col span={24} md={6}>
                            <Form.Item
                                ...
                                rules={[{ required: true, message: "Please input Minimum Order Quantity!" }]}
                            >
                                <Input type="number" placeholder="Enter Quantity" />
                            </Form.Item>
                        </Col>
                    ...
                    <Col span={24} md={4}>
                        <Form.Item
                            ...
                            rules={[{ required: true, message: "Please enter volume weight!" }]}
                        >
                    ...
                    <Col span={24} md={4}>
                        <Form.Item label="Prod Weight" name={["dimensions", "prodWeight"]} rules={[{ required: true, message: "Please enter Prod weight!" }]}>
                            <Input type="number" placeholder="Enter Prod Weight" />
                        </Form.Item>
                    </Col>

                    <Col span={24} md={4}>
                        <Form.Item label="Ship Weight" name={["dimensions", "shipWeight"]} rules={[{ required: true, message: "Please enter Ship weight!" }]}>
                    ...
                    <Col span={24} md={4}>
                        <Form.Item label="Breadth" name={["dimensions", "breadth"]} rules={[{ required: true, message: "Please enter Breadth!" }]}>
                            <Input type="number" placeholder="Enter Breadth" />
                        </Form.Item>
                    </Col>

                    <Col span={24} md={4}>
                        <Form.Item label="Height" name={["dimensions", "height"]} rules={[{ required: true, message: "Please enter Height!" }]}>
                    ...
                    <Col span={24} md={12}>
                        <Form.Item label="Main Image" name="mainImage">
                            <Input
                                type="file"
                                title={"Add Image"}
                                onChange={(event) => handleChangeMainImage(event.target.files[0])}
                    ...
                    <Col span={24} md={12}>
                        <Form.Item label="Behind Image" name="behindImage">
                            <Input
                                type="file"
                                title={"Add Image"}
                                onChange={(event) => handleChangeBehindImage(event.target.files[0])}
                                accept="image/jpeg,image/png,image/svg"
                                aria-label="Upload File"
                            />
                            {behindImgPreview && (
